...
set "MODELS_ROOT=%~dp0..\sprite-video-lab-models"
if "%SPRITE_VIDEO_LAB_WORK_DIR%"=="" if exist "%MODELS_ROOT%\work" set "SPRITE_VIDEO_LAB_WORK_DIR=%MODELS_ROOT%\work"
if "%SPRITE_VIDEO_LAB_WORK_DIR%"=="" if exist "E:\" set "SPRITE_VIDEO_LAB_WORK_DIR=E:\sprite-video-lab-work"
if "%SPRITE_VIDEO_LAB_AI_MODEL_CACHE%"=="" if exist "%MODELS_ROOT%\huggingface" set "SPRITE_VIDEO_LAB_AI_MODEL_CACHE=%MODELS_ROOT%\huggingface"
if "%SPRITE_VIDEO_LAB_AI_MODEL_CACHE%"=="" if exist "E:\" set "SPRITE_VIDEO_LAB_AI_MODEL_CACHE=E:\sprite-video-lab-models\huggingface"
if "%SPRITE_VIDEO_LAB_CORRIDORKEY_ROOT%"=="" if exist "%MODELS_ROOT%\EZ-CorridorKey" set "SPRITE_VIDEO_LAB_CORRIDORKEY_ROOT=%MODELS_ROOT%\EZ-CorridorKey"
if "%SPRITE_VIDEO_LAB_CORRIDORKEY_ROOT%"=="" if exist "E:\" set "SPRITE_VIDEO_LAB_CORRIDORKEY_ROOT=E:\sprite-video-lab-models\EZ-CorridorKey"
...
if exist "%MODELS_ROOT%\venv\Scripts\python.exe" (
  set "PYTHON_EXE=%MODELS_ROOT%\venv\Scripts\python.exe"
  goto :python_ready
)
